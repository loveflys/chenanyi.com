...
R.sources = 
[
	//{id:"cannon", size:50, src:"/game/image/fish/cannon-hd.png?"+Math.random()},
	//{id:"fish", size:50, src:"/game/image/fish/fish-hd.png?"+Math.random()},
	//{id:"shark", size:50, src:"/game/image/fish/shark-hd.png?"+Math.random()},
	{id:"mainbg", size:456, src:"/game/image/fish/game_bg_2_hd.jpg?"+Math.random()},
	{id:"bottom", size:50, src:"/game/image/fish/bottom.png?"+Math.random()},
	{id:"fish1", size:6, src:"/game/image/fish/fish1.png?"+Math.random()},
	{id:"fish2", size:16, src:"/game/image/fish/fish2.png?"+Math.random()},
	{id:"fish3", size:11, src:"/game/image/fish/fish3.png?"+Math.random()},
	{id:"fish4", size:15, src:"/game/image/fish/fish4.png?"+Math.random()},
	{id:"fish5", size:43, src:"/game/image/fish/fish5.png?"+Math.random()},
	{id:"fish6", size:45, src:"/game/image/fish/fish6.png?"+Math.random()},
	{id:"fish7", size:80, src:"/game/image/fish/fish7.png?"+Math.random()},
	{id:"fish8", size:100, src:"/game/image/fish/fish8.png?"+Math.random()},
	{id:"fish9", size:104, src:"/game/image/fish/fish9.png?"+Math.random()},
	{id:"fish10", size:121, src:"/game/image/fish/fish10.png?"+Math.random()},
	{id:"shark1", size:287, src:"/game/image/fish/shark1.png?"+Math.random()},
	{id:"shark2", size:382, src:"/game/image/fish/shark2.png?"+Math.random()},
	{id:"cannon1", size:11, src:"/game/image/fish/cannon1.png?"+Math.random()},
	{id:"cannon2", size:11, src:"/game/image/fish/cannon2.png?"+Math.random()},
	{id:"cannon3", size:11, src:"/game/image/fish/cannon3.png?"+Math.random()},
	{id:"cannon4", size:13, src:"/game/image/fish/cannon4.png?"+Math.random()},
	{id:"cannon5", size:13, src:"/game/image/fish/cannon5.png?"+Math.random()},
	{id:"cannon6", size:15, src:"/game/image/fish/cannon6.png?"+Math.random()},
	{id:"cannon7", size:17, src:"/game/image/fish/cannon7.png?"+Math.random()},
	{id:"bullet", size:8, src:"/game/image/fish/bullet.png?"+Math.random()},
	{id:"web", size:93, src:"/game/image/fish/web.png?"+Math.random()},
	{id:"numBlack", size:1, src:"/game/image/fish/number_black.png?"+Math.random()},
	{id:"coinAni1", size:19, src:"/game/image/fish/coinAni1.png?"+Math.random()},
	{id:"coinAni2", size:22, src:"/game/image/fish/coinAni2.png?"+Math.random()},
	{id:"coinText", size:16, src:"/game/image/fish/coinText.png?"+Math.random()}
];
